...
class PayrollGUI:
    ...
    def __init__(self, root):
        ...
        self.button = tk.Button(root, text="Calculate Salary",fg="black",bg="blue", command=self.calculate)
        self.button.pack(pady=10)

        # Reset Button
        self.reset_button = tk.Button(root, text="Reset", fg="black",bg="pink",command=self.reset_fields)
        self.reset_button.pack(pady=5)

        # Exit Button
        self.exit_button = tk.Button(root, text="Exit",fg="black",bg="yellow", command=root.quit)
